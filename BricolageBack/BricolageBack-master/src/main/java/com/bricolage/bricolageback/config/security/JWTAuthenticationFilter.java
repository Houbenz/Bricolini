...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	{
		com.bricolage.bricolageback.entities.User user = null;
		try {
			user = new ObjectMapper().readValue(request.getInputStream(), com.bricolage.bricolageback.entities.User.class);
		} catch (Exception e) {
